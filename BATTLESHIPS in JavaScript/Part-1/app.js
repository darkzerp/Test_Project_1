...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function createBoard(grid, squares) {
        for (let i = 0; i < width * width; i++) {
            const square = document.createElement('div') // Utworzenie elementu div i dopisanie go do square
            square.dataset.id = i // nadanie elementowi identyfukatora data-id
            grid.appendChild(square) // utworzenie jako elementu dziecko do elementu grid - userGrid albo computerGrid
            squares.push(square) // pushowanie kolejnych elementów w tablicy userSquares albo computerSquares
        }
    }
    ...
    // Draw the computers ships in a random locations
